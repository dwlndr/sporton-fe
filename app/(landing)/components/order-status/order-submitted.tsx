...
const OrderSubmitted = () => {
  ...
  return (
    <div className="bg-white w-160 p-16 flex flex-col justify-center items-center mx-auto rounded-lg shadow-md">
      <Image
        src="/images/order-icons/icon-order-submitted.svg"
        alt="Order Submitted"
        width={117}
        height={117}
        className="mb-4"
